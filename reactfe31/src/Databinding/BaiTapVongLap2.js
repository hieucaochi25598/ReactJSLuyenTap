            ...
            danhSachPhim: [
                {
                    ...
                    tenPhim: "Ted 35",
                    biDanh: "ted-35",
                    trailer: "https://www.youtube.com/watch?v=v2VIFCHSdrM",
                    hinhAnh: "http://movie0706.cybersoft.edu.vn/hinhanh/ted-35_gp01.jpg",
                    moTa:
    ...
    render() {
        return (
            <div className="container">
                <div className="row">
                    {this.state.danhSachPhim.map((phim, index) => (
                        <Phim key={index} phimprops={phim}/>
                    ))
                    }
                </div>
            </div>
